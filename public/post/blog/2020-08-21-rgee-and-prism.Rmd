...
river_total <- tobacco_river %>% filter(!year %in% c("1958", "1959", "2019" , "2020")) %>% group_by(year, month) %>% summarise(total_q = sum(Flow), max_q = max(Flow), sd_q = round(sd(Flow),2))
